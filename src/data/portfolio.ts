...
export const socials: SocialLink[] = [
  ...
  {
    label: 'Phone',
    href: 'tel:+916283063136',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.8a19.79 19.79 0 01-3.07-8.64A2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z"/></svg>`,
  },
];
...
export const experiences: ExperienceItem[] = [
  {
    ...
    current: true,
    summary: 'Technical lead for Actapay, a live non-custodial multi-chain crypto payment gateway enabling merchants to accept stablecoin payments.',
    bullets: [
    ...
    highlight: 'Highlight: 65%+ reduction in infrastructure costs through cloud architecture re-design.',
    skills: ['TypeScript', 'Node.js', 'Docker', 'GitHub Actions', 'Solidity', 'Microservices'],
  },
  {
    id: 2,
    ...
    summary: 'Engineered ETHCODE, a VSCode extension for deploying and interacting with Ethereum smart contracts.',
    bullets: [
    ...
    highlight: 'Highlight: ETHCODE shipped as a published VSCode Marketplace extension.',
    skills: ['TypeScript', 'React.js', 'Solidity', 'Ethers.js', 'EIP-4337', 'VSCode Extension API'],
  },
  {
    id: 3,
    ...
    location: 'Remote',
    summary: 'Built developer productivity tooling for interacting with Solidity smart contracts as part of the ETHIndia fellowship.',
    bullets: [
    ...
    highlight: 'Highlight: Layer achieved 3000+ downloads from the developer community.',
    skills: ['React.js', 'TypeScript', 'Node.js', 'Solidity', 'Ethers.js', 'VSCode Extension API'],
  },
  {
    id: 4,
    ...
    summary: 'Contributed to a blockchain-based DAO management platform with Gnosis Safe multisig integration.',
    bullets: [
    ...
    highlight: 'Highlight: Shipped Gnosis Safe multisig integration for DAO treasury management.',
...
export const projects: Project[] = [
  {
    id: 1,
    title: 'Actapay',
    objective: 'Non-custodial crypto payment gateway enabling merchants to accept stablecoin payments across 6 EVM chains.',
    summary: 'Built a production-grade multi-chain payment infrastructure from the ground up as technical lead.',
    bullets: [
    ...
    highlight: 'Highlight: Live in production, processing real transactions across 6 mainnets.',
    tech: ['TypeScript', 'Node.js', 'Express.js', 'Hono', 'Docker', 'Solidity', 'Microservices'],
    year: '2024',
  },
  {
    id: 2,
    title: 'Gaspay',
    objective: 'Production-grade ERC-4337 verifying paymaster infrastructure for gasless user experiences.',
    summary: 'An in-house transaction sponsorship platform that replaced expensive third-party paymasters.',
    bullets: [
    ...
    highlight: 'Highlight: 75%+ reduction in operational costs vs. third-party paymaster services.',
  ...
  },
  {
    id: 3,
    title: 'Layer',
    objective: 'Open-source VSCode extension for deploying, executing, debugging, and testing Solidity smart contracts.',
    summary: 'A developer tool built during the ETHIndia Gwei Track Fellowship with a growing open-source community.',
    bullets: [
    ...
    highlight: 'Highlight: 3000+ downloads from the Ethereum developer community.',
    tech: ['React.js', 'TypeScript', 'Node.js', 'Solidity', 'Ethers.js', 'VSCode Extension API'],
